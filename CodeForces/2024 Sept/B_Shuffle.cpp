...
int32_t main()
{
    ...
    auto solve = [&] () {
        ...
        ll l1,r1;
        cin>>l1>>r1;
        if(l1<=p.first && r1>=p.second){
            p.first = min(p.first,l1);
            p.second = max(p.second,r1);
        }
        m--;
        while(m--){
            ll l,r;
            ...
            if(p.first==p.second){
                if(l<=p.first && r>=p.second){
                    p.first = min(p.first,l);
                    p.second = max(p.second,r);
                }
            }
            else{
                if(l<=p.first && r>=p.second){
                ...
                else if(l<=p.first && r>=p.first){
                    p.first = min(p.first,l);
                }
                else if(l<=p.second && r>=p.second){
                    p.second = max(p.second,r);
                }
            }
